...
def get_common_args():
    ...
    parser.add_argument('--n_vehicles', type=int, default=5, help='numbers of vehicles')
    parser.add_argument('--n_base_stations', type=int, default=2, help='numbers of base stations')
    ...
    parser.add_argument('--n_steps', type=int, default=500, help='total time steps')  # 500000
    parser.add_argument('--n_episodes', type=int, default=5, help='the number of episodes before once training')
    ...
    parser.add_argument('--lastreward', type=bool, default=False, help='draw last reward or not')
