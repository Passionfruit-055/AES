...
def get_common_args():
    ...
    parser.add_argument('--buffer_size', type=int, default=1000, help='the size of the buffer')
    parser.add_argument('--batch_size', type=int, default=32, help='the size of the batch')
    parser.add_argument('--replace', type=int, default=500, help='replace target network every 200 steps')
